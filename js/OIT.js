...
// var calorMap = L.imageOverlay('IMG/Desmotadora_Mcalor.png',[[-24.748,-65.162],[ -30.474,-57.987]]);
...
// }
// L.control.layers(baseMaps,capas,{collapsed:false}).addTo(map);
// L.control.layers(null,capas1,{}).addTo(map);
// Añadir leyenda en función del mapa que se selecciona
// var legend = L.control({position: 'bottomleft'});
// var ChangeLegend = L.control({position: 'bottomleft'});
// var etqMapCalor = L.control({position: 'bottomleft'});

// legend.onAdd = function(map){
//     var div = L.DomUtil.create('div','info legend');
//     div.innerHTML +=
//     '<img id = "legend" src="IMG/leyenda_area_sembrada.jpg" width="120" height="150"/>';
//     return div;
// };
// ChangeLegend.onAdd = function (map) {
//     var div = L.DomUtil.create('div', 'info legend');
//     div.innerHTML +=
//     '<img id = "legend" src="IMG/RTI_leyenda.jpg" width="120" height="150"/>';
//     return div;
// };
// etqMapCalor.onAdd = function (map) {
//     var div = L.DomUtil.create('div', 'info legend');
//     div.innerHTML +=
//     '<img id = "legend" src="IMG/Etq_Mapa_de_calor_Desmotadoras.jpg" width="120" height="150"/>';
//     return div;
// };
...
//     } else if (eventLayer.name === 'Algodón 19-20' || eventLayer.name === 'Algodón 18-19') {
